      ...
      <div className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
        ...
        <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div>
            ...
            <input type="number" min={1} max={100} value={punti} onChange={(e) => setPunti(Number(e.target.value))} className="w-full rounded-md border border-neutral-300 px-3 py-2 text-sm" />
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          <input type="number" min={0} value={ittGiorni} onChange={(e) => setIttGiorni(Number(e.target.value))} className="w-full rounded-md border border-neutral-300 px-3 py-2 text-sm" />
        </div>
        ...
        <div className="mb-4">
          ...
          <input type="number" min={0} step={0.01} value={speseMediche} onChange={(e) => setSpeseMediche(Number(e.target.value))} className="w-full rounded-md border border-neutral-300 px-3 py-2 text-sm" />
        </div>

        <div>
          <label className="mb-1 block text-xs text-neutral-500">Personalizzazione (%) — scelta discrezionale entro il tetto di legge</label>
          <input type="number" min={0} max={50} value={personalizzazione} onChange={(e) => setPersonalizzazione(Number(e.target.value))} className="w-full rounded-md border border-neutral-300 px-3 py-2 text-sm" />
      ...
      <div className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
        ...
        <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div>
            ...
            <input type="number" min={1} max={9} step={0.1} value={punti} onChange={(e) => setPunti(Number(e.target.value))} className="w-full rounded-md border border-neutral-300 px-3 py-2 text-sm" />
          </div>
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setPersonalizzazione(Number(e.target.value))} className="w-full rounded-md border border-neutral-300 px-3 py-2 text-sm"
          />
          <p className="mt-1 text-[11px] text-neutral-400">
      ...
      <div className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
        ...
        <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div>
            ...
            <input type="number" min={10} max={100} step={0.1} value={punti} onChange={(e) => setPunti(Number(e.target.value))} className="w-full rounded-md border border-neutral-300 px-3 py-2 text-sm" />
          </div>
        </div>

        <div className="mb-4">
          <label className="mb-1 block text-xs text-neutral-500">Danno morale (Tavola 2)</label>
          <select value={tipoMorale} onChange={(e) => setTipoMorale(e.target.value as TipoMorale)} className="w-full rounded-md border border-neutral-300 px-3 py-2 text-sm">
        ...
        <div className="mb-4">
          ...
          <input type="number" min={30} max={60} value={incrementoMorale} onChange={(e) => setIncrementoMorale(Number(e.target.value))} className="w-full rounded-md border border-neutral-300 px-3 py-2 text-sm" />
        </div>
