    ...
    <>
      ...
      <div>
        ...
        <input
          ...
          placeholder="CL"
          className="w-full rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm uppercase outline-none transition-colors focus:border-bordeaux-400 focus:bg-white"
        />
