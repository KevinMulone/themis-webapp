      ...
      <div className="my-8 w-full max-w-2xl rounded-xl bg-white p-6 shadow-lg">
        ...
        {fase === 'scrittura' ? (
          <div className="flex flex-col gap-3">
            ...
            <div className="rounded-2xl bg-white ring-1 ring-black/[0.04] p-3">
            ...
            {documenti.length > 0 && (
              <div>
                ...
                <div className="max-h-40 space-y-1 overflow-y-auto rounded-2xl bg-white ring-1 ring-black/[0.04] p-2">
                  {documenti.map((d) => (
          ...
          <div className="flex flex-col gap-4">
            <div className="rounded-2xl bg-white ring-1 ring-black/[0.04] p-4 text-sm">
