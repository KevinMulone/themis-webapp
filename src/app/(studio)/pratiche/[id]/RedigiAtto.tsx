          ...
          <form onSubmit={handleRedigi} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="min-h-24 w-full rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm outline-none transition-colors focus:border-bordeaux-400 focus:bg-white"
              />
              <p className="mt-1 text-xs text-neutral-400">
