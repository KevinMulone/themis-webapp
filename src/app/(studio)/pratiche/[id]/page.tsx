    ...
    <div className="mx-auto max-w-3xl">
      ...
      <form onSubmit={handleSaveMatter} className="mb-4 rounded-xl bg-neutral-50 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div>
            ...
            <select name="stato" defaultValue={matter.stato} className="w-full rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm outline-none transition-colors focus:border-bordeaux-400 focus:bg-white">
          ...
          <div>
            ...
            <select name="metodo_pagamento" defaultValue={matter.metodo_pagamento ?? ''} className="w-full rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm outline-none transition-colors focus:border-bordeaux-400 focus:bg-white">
      ...
      <div className="mb-4 rounded-xl bg-neutral-50 p-6">
        ...
        <form onSubmit={handleCreaRichiesta} className="grid grid-cols-1 md:grid-cols-2 gap-3 border-t border-neutral-200 pt-4">
          <input name="titolo" required placeholder="Es. Copia carta d'identità" className="w-full rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm outline-none transition-colors focus:border-bordeaux-400 focus:bg-white" />
          <input name="note" placeholder="Nota per il cliente (opzionale)" className="w-full rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm outline-none transition-colors focus:border-bordeaux-400 focus:bg-white" />
        ...
        <form onSubmit={handleSavePatrocinio} className="mb-4 rounded-xl bg-neutral-50 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <select name="stato_istanza" defaultValue={patrocinio?.stato_istanza ?? ''} className="w-full rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm outline-none transition-colors focus:border-bordeaux-400 focus:bg-white">
                <option value="">Non specificato</option>
          ...
          <form onSubmit={handleSaveSinistro} className="mb-4 rounded-xl bg-neutral-50 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div>
                ...
                <select name="tipo_sinistro" defaultValue={sinistro.tipo_sinistro ?? ''} className="w-full rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm outline-none transition-colors focus:border-bordeaux-400 focus:bg-white">
                  <option value="">Non specificato</option>
              ...
              <div>
                ...
                <select name="stato_negoziazione" defaultValue={sinistro.stato_negoziazione} className="w-full rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm outline-none transition-colors focus:border-bordeaux-400 focus:bg-white">
              ...
              <div className="col-span-2">
                ...
                <textarea name="dinamica" defaultValue={sinistro.dinamica ?? ''} className="w-full rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm outline-none transition-colors focus:border-bordeaux-400 focus:bg-white" />
              </div>
              <div className="col-span-2">
                <label className="mb-1 block text-xs text-neutral-500">Note</label>
            ...
            {addingTestimone && (
              <form onSubmit={handleAddTestimone} className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3 border-t border-neutral-200 pt-4">
                ...
                <div className="col-span-2">
                  ...
                  <textarea name="dichiarazione" className="w-full rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm outline-none transition-colors focus:border-bordeaux-400 focus:bg-white" />
                </div>
