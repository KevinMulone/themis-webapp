                ...
                <div key={k} className="flex flex-wrap items-center gap-3">
                  ...
                  <div className="flex items-center gap-1">
                    <input
                      ...
                      className="w-20 rounded-lg border border-neutral-200 bg-white px-2 py-1 text-right text-xs outline-none transition-colors focus:border-bordeaux-400 focus:bg-white"
                    />
          ...
          {chiaveGenerata && (
            <div className="mt-4 border-t border-neutral-100 pt-4">
              ...
              <textarea
                ...
                className="mb-2 min-h-20 w-full rounded-lg border border-neutral-200 bg-white px-3 py-2 font-mono text-xs outline-none transition-colors focus:border-bordeaux-400 focus:bg-white"
              />
                  ...
                  <tr key={s.id} className={`border-t border-neutral-100 align-top ${s.refund_requested_at ? 'bg-red-50' : ''}`}>
                    ...
                    <td className="px-3 py-3">
                      <select
                        ...
                        className="rounded border border-neutral-200 bg-white px-1.5 py-0.5 text-xs outline-none transition-colors focus:border-bordeaux-400 focus:bg-white"
                      >
