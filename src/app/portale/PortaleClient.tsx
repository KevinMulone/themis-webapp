        ...
        {!session && invite && !invite.used && (
          <div className="rounded-xl bg-neutral-50 p-6">
            ...
            <form onSubmit={handleRegister} className="flex flex-col gap-3">
              <input name="password" type="password" placeholder="Almeno 8 caratteri" className="rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm outline-none transition-colors focus:border-bordeaux-400 focus:bg-white" />
        ...
        {!session && !invite && (
          <div className="rounded-xl bg-neutral-50 p-6">
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-3">
              <input name="email" type="email" placeholder="Email" className="rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm outline-none transition-colors focus:border-bordeaux-400 focus:bg-white" />
              <input name="password" type="password" placeholder="Password" className="rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm outline-none transition-colors focus:border-bordeaux-400 focus:bg-white" />
              {error && <p className="text-sm text-red-600">{error}</p>}
