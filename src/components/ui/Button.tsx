...
const VARIANTI: Record<Variant, string> = {
  ...
  primary: 'bg-bordeaux-700 text-white hover:bg-bordeaux-800 disabled:opacity-50',
  ...
  ghost: 'text-neutral-500 hover:bg-neutral-100 hover:text-neutral-800 disabled:opacity-50',
  // Si comporta come testo cliccabile, non come un pulsante: per azioni
  // secondarissime ("Annulla", "Torna a modificare").
  link: 'text-bordeaux-700 hover:underline disabled:opacity-50',
};
...
export const Button = forwardRef<HTMLButtonElement, React.ButtonHTMLAttributes<HTMLButtonElement> & {
  ...
  const base = variant === 'link'
    ...
    : 'rounded-md font-semibold disabled:cursor-not-allowed';
